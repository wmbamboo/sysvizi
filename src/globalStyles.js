...
class GlobalStyles {
  constructor () {
    this.styles = {
      ...
      colorLabelBorder: 'rgb(16, 17, 18)', // noted by hezl
      colorLabelText: 'rgb(0, 0, 0)', // noted by hezl  1aabff  33ccff  3333ff
      colorLabelBorderGlobal: 'rgb(51,51,255)',
      colorLabelTextGlobal: 'rgb(235,184,74)',
      // colorLabelTextGlobal: 'rgb(51,204,255)',

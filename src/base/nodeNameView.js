...
class NodeNameView extends BaseView {
  ...
  updateLabel () {
    ...
    let fontSize = this.fixedWidth ? 22 : 18;
    if (this.nodeView.object.graphRenderer === 'global') { // added bby hezl
      fontSize = 22;
    }
    ...
    if (this.nodeView.object.graphRenderer === 'global') { this.labelWidth = 130; } // added by hezl
    ...
    if (this.nodeView.object.graphRenderer === 'global') { // added bby hezl
      // roundRect(context, 0, 0, this.nameCanvas.width, this.nameCanvas.height, 3, GlobalStyles.styles.colorLabelBorderGlobal, GlobalStyles.styles.colorBackgroundDark);
      roundRect(context, 0, 0, this.nameCanvas.width, this.nameCanvas.height, 3, GlobalStyles.styles.colorLabelBorderGlobal, GlobalStyles.styles.colorLabelBorderGlobal);
      context.fillStyle = GlobalStyles.styles.colorDonutInternalColorHighlighted; // 白色
      // context.fillStyle = GlobalStyles.styles.colorLabelTextGlobal; // 橙色
    } else {
  ...
  applyPosition () {
    ...
    if (this.nodeView.object.graphRenderer === 'global') { // added by HEZL
      x = 0;
      y = 145;
    }

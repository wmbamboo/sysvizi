 ...
 * ## Props
 */
class SysVizi extends React.Component {
  componentDidMount () {
    ...
    if (!isEqual(this.props.filters, SysVizi.defaultProps.filters)) {
      this.vizceral.setFilters(this.props.filters);
    }

    if (!isEqual(this.props.definitions, SysVizi.defaultProps.definitions)) {
    ...
    // animate properly.
    setTimeout(() => {
      this.vizceral.setView(this.props.view || SysVizi.defaultProps.view, this.props.objectToHighlight);

...
import LayoutWorker from 'worker-loader!./ltrTreeLayoutWorker';
// import LayoutWorker from 'worker-loader?inline!./ltrTreeLayoutWorker';
...
class LTRTreeLayout {
  ...
  run (graph, dimensions, layoutComplete) {
    ...
    if (existingPositions) {
      ...
      const layoutWorker = Worker(LayoutWorker);
